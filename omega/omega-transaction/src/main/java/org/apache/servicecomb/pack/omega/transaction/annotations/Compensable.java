...
/**
 * Indicates the annotated method will start a sub-transaction. <br> It is suggested to use the Spring Transactional
 * annotation to wrap the sub-transaction method. A <code>@Compensable</code> method should satisfy below requirements:
 * <ol>
...
public @interface Compensable {
    ...
    /**
     * The retires number of the forward compensable method. Default value is 0, which means never retry it value is -1,
     * which means retry it until succeed value &gt; 0, which means the retry number value &lt; -1, an
    ...
    /**
     * The retires number of the reverse compensable method. Default value is 0, which means never retry it value &gt;
     * 0, which means the retry number value &lt; 0, an IllegalArgumentException will be thrown
     *
    ...
    /**
     * Compensation method name.<br> A compensation method should satisfy below requirements:
     * <ol>
